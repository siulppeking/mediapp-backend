...
public class ExamenRestController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse> insertar(@Valid @RequestBody Examen examen) {
        ApiResponse ar = new ApiResponse();
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse> actualizar(@PathVariable Integer id, @Valid @RequestBody Examen examen) {
        ApiResponse ar = new ApiResponse();
        try {
